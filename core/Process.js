...
export default class Process {
  ...
  input(...args) {
    return this._inputs.port(...args);
  }
  output(...args) {
    return this._outputs.port(...args);
  }
  inputArray(key) {
    return this._inputs.array(key).ports();
  }
  outputArray(key) {
    return this._outputs.array(key).ports();
  }
  ...
  ownedIPs() {
    return Object.getOwnPropertySymbols(this._ownedIPs).map(
      sym => this._ownedIPs[sym]
    );
  }
